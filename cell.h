...
///////////  wasp Methods  /////////////////
    ...
    void setmaxNoWasps(
            int val) { m_maxNoWasps = val; }  //val can be used elsewhere too because it is only stored/valid while in this fn
    ...
    unsigned long getNumLarvae(); //returns the number of cooperators in the cell
    //////////   kairomone methods  /////////////////
